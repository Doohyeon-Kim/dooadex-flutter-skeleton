      ...
      body: Column(
        children: [
          ...
          MultiProvider(
            ...
            child: Consumer<DetermineProgressBarViewModel>(builder: (context, determineProgressBarViewModel, child) {
              return Column(
                children: [
                  ProgressBar.determinate(progress: determineProgressBarViewModel.progress),
                  Row(
                      ...
                      for (int i = 0; i <= 5; i++)
                        Padding(
                          ...
                          child: DooadexButton.filled(
                            onPressed: () {
                              determineProgressBarViewModel.setProgress(progress: ((i * 20).toDouble()) * 0.01);
                            },
